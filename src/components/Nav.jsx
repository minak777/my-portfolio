  ...
  return (
    <div>
      <IoMenu
        size={25}
        onClick={handleNav}
        className="absolute top-4 right-4 z-[99] md:hidden text-teal-400"
      />
      {nav ? (
        <div className="fixed w-full h-screen bg-gray-900 flex flex-col justify-center items-center z-20">
          <a
            href="#main"
            className="w-[75%] flex justify-center items-center  rounded-full shadow-lg bg-gray-800 shadow-teal-600 m-5 p-4 cursor-pointer hover:scale-110 ease-in duration-200"
          >
