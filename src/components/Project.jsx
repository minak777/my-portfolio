...
function Project() {
  return (
    <div className="h-auto w-full flex flex-col justify-start bg-gradient-to-r from-gray-950 to-gray-800 pt-28">
      <span className="flex justify-center text-6xl font-semibold text-teal-400 font-body">
        Projects
      </span>

      {/* Desktop Version */}
      <div className="w-full flex flex-row justify-between items-center px-32 hidden md:flex">
        <div
          onClick={() =>
      ...
      {/* */}
      <div className="w-full flex flex-row justify-start items-center px-32 hidden md:flex">
        <div
          onClick={() =>
            window.open(
